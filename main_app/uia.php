...
<html lang="es">
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="container container-fullwidth">
      ...
      <h2 class="mt-4 mb-3 mt-right">UNIVERSIDAD INTERNACIONAL DE LAS AMÉRICAS</h2>
      ...
      <h4>Visite la página oficial de: <a href="https://uia.ac.cr/" target="_blank">UNIVERSIDAD INTERNACIONAL DE LAS AMÉRICAS</h4>
      <br>
      <h4>Video informativo</h4>
          <div class="row-videos         <div class="row-videos float-center">
              <iframe src="https://www.youtube.com/embed/Wao2m5b8SrM" allowfullscreen></iframe> <!-- aqui copiar igual y solo agregar el id del código -->
          </div></a>
    	</div>
 </div>
    <!-- /.container -->
