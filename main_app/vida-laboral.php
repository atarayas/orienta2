...
<html lang="es">
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="container container-fullwidth">
      ...
      <h2 class="mt-4 mb-3 mt-right">Vida laboral</h2>

      <ol class="breadcrumb right">
        <li class="breadcrumb-item">
          <a href="principal.php">Inicio</a>
        </li>
        <li class="breadcrumb-item active">Vida laboral</li>
      </ol>
      ...
      <h4>Videos</h4>
      <div id="gallery-videos" style="display:none;">
        <img alt="Importancia de la ortografía"
          data-type="vimeo"
          src="https://i.vimeocdn.com/video/727689809.jpg"
          data-image="https://i.vimeocdn.com/video/727689809.jpg"
          data-videoid="291527453"
          data-description="Directora Editorial de Revista Traffic">

    		<img alt="Tips para entrevistas laborales"
    			 data-type="vimeo"
