...
<html lang="es">
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="container container-fullwidth">
      ...
      <h2 class="mt-4 mb-3 mt-right">LEAD University</h2>
      ...
      <li class="breadcrumb-item">
        ...
        <li class="breadcrumb-item active">LEAD University</li>
      </ol>

      <h3>Visite la página oficial de: <a href="https://ulead.ac.cr/es" target="_blank">LEAD University</a></h3>
      <br>
      <h3>Video informativo</h3>
      <hr>
          <div class="video-universidad">
              <iframe src="https://www.youtube.com/embed/Mz-LGlvPxFE" allowfullscreen></iframe> <!-- aqui copiar igual y solo agregar el id del código -->
          </div>
    	</div></a>
 </div>
    <!-- /.container -->
