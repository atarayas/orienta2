...
<html lang="es">
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="container container-fullwidth">
      ...
      <h2 class="mt-4 mb-3 mt-right">UNIVERSIDAD FUNDEPOS</h2>
      ...
      <hr>
          <div class="video-universidad">
              <iframe src="https://www.youtube.com/embed/nAxEaOupBlE" allowfullscreen></iframe> <!-- aqui copiar igual y solo agregar el id del código -->
          </div>
    	</div>
 </div>
    <!-- /.container -->
