...
<html lang="es">
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="container container-fullwidth">
      ...
      <h2 class="mt-4 mb-3 mt-right">Instituto Politécnico Internacional</h2>

      <ol class="breadcrumb right">
        <li class="breadcrumb-item">
          <a href="encuentro2.php">Inicio</a>
        </li>
        <li class="breadcrumb-item active">Instituto Politécnico Internacional</li>
      </ol>

      <h3>Visite la página oficial de: <a href="http://www.upi.ac.cr/" target="_blank">Instituto Politécnico Internacional</a></h3>
      <br>
          <h3>Video informativo</h3>
      <hr>
          <div class="video-universidad">
              <iframe src="https://www.youtube.com/embed/9vlEK1VrzBY" allowfullscreen></iframe> <!-- aqui copiar igual y solo agregar el id del código -->
          </div>
    	</div>
 </div>
    <!-- /.container -->
