...
<html lang="es">
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="container container-fullwidth">
      ...
      <h2 class="mt-4 mb-3 mt-right">UNIVERSIDAD ESTATAL A DISTANCIA</h2>
      ...
      <h4>Visite la página oficial de: <a href="https://www.uned.ac.cr/" target="_blank">UNIVERSIDAD ESTATAL A DISTANCIA</h4>
      <br>
