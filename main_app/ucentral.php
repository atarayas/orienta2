...
<html lang="es">
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="container container-fullwidth">
      ...
      <h2 class="mt-4 mb-3 mt-right">Universidad Central</h2>
      ...
      <h3>Visite la página oficial de: <a href="https://www.universidadcentral.ac.cr" target="_blank">Universidad Central</a></h3>
      
      <h3>Video informativo</h3>
      <hr>
      <div class="video-universidad">
              <iframe src="https://www.youtube.com/embed/1wQ3ozoE5Qg" allowfullscreen></iframe> <!-- aqui copiar igual y solo agregar el id del código -->
      </div>
 </div>
    <!-- /.container -->
