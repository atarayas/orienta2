...
<html lang="en">
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="container container-fullwidth">
      ...
      <h2 class="mt-4 mb-3 mt-right">Financiar tus estudios</h2>
      ...
      <div class="ih-item circle colored effect1"><a href="http://www.conape.go.cr/" target="_blank">
        ...
        <div class="ih-item circle colored effect1"><a href="http://infoues.conare.ac.cr/web/infoues/becas-y-financiamiento" target="_blank">
             <div class="spinner"></div>
            <div class="img"><img src="../img/buttons/btn-infoues.png" alt="img"></div>
            <div class="info">
              <div class="info-back">
                <h3>Click aquí</h3>
                <p>Mi carrera es mi futuro</p>
              </div>
            </div></a>
        </div>
