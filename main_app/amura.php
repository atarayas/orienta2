...
<html lang="es">
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="container container-fullwidth">
      ...
      <h2 class="mt-4 mb-3 mt-right">AMURA Centro Culinario</h2>

      <ol class="breadcrumb right">
        <li class="breadcrumb-item">
          <a href="encuentro2.php">Inicio</a>
        </li>
        <li class="breadcrumb-item active">AMURA Centro Culinario</li>
      </ol>

      <h3>Visite la página oficial de: <a href="https://amura.cr/" target="_blank">AMURA Centro Culinario</a></h3>
      <br>
              <h3>Video informativo</h3>
      <hr>
      <hr>
          <div class="video-universidad">
              <iframe src="https://www.youtube.com/embed/kT1ChwaaR2w" allowfullscreen></iframe> <!-- aqui copiar igual y solo agregar el id del código -->
          </div>
    	</div>
 </div>
    <!-- /.container -->
