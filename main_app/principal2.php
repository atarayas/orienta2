      ...
      <div class="row">
        ...
        <div id="center-col" class="col-md-6 col-carousel">
          <div id="carouselExampleIndicators" class="carousel slide border-carousel" data-ride="carousel">
            ...
            <div class="carousel-item active" style="background-image: url('../img/encuentro_mujeres.png')">
              ...
              <div class="carousel-item active" style="background-image: url('../img/orientacion2020.jpg')">
                <div class="carousel-caption carousel-background d-md-block">
        ...
        <div id="right-col" class="col-md-3">
           ...
           <div id="image-novedades" class="btn-block">
              <div class="card styleCard">
                  ...
                  <p class="modal-events cortar" data-toggle="modal" data-target="#myModal1"><i class="fa fa-calendar-alt" alt="Curso capacitación a orientadores">&nbsp;</i>Encuentro de Mujeres en Ciencia y Tecnología</a></p>
                   ...
                   <div class="modal-content">
                      ...
                      <div class="modal-header carousel-background btn-right d-flex flex-column">
                        <div class="d-flex flex-row">
                            <h4 class="modal-title text-center ">Encuentro de Mujeres en Ciencia y Tecnología</h4>
                      ...
                      <div class="modal-body">
                          <p> <strong>Fecha: </strong>22 de Octubre de 2020</p>
                          <!-- <p> <strong>Horario: </strong>de 8:00am a 4:00pm</p> -->
                          <p> <strong>Tema: </strong>Solicitarlo.</p>
                          <p> <strong>Lema: </strong>Solicitarlo.</p>
                          <p><img class="img-thumbnail"  src="../img/encuentro_mujeres1.jpg" alt="Encuentro de Mujeres en Ciencia y Tecnología"> </p>
                      </div>
                      <!-- Modal footer -->
