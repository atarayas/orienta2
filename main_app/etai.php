...
<html lang="es">
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="container container-fullwidth">
      ...
      <h2 class="mt-4 mb-3 mt-right">ETAI PARAUNIVERSITARIA</h2>
      ...
      <h4>Visite la página oficial de: <a href="https://www.etai.ac.cr/etai/" target="_blank">ETAI PARAUNIVERSITARIA</h4>
      <br>
      <h4>Video informativo</h4>
          <div class="row-videos float-center">
              <iframe src="https://www.youtube.com/embed/SF3G4J_ZD9E" allowfullscreen></iframe> <!-- aqui copiar igual y solo agregar el id del código -->
          </div></a>
    	</div>
 </div>
    <!-- /.container -->
