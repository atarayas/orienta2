...
<html lang="es">
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="container container-fullwidth">
      ...
      <h2 class="mt-4 mb-3 mt-right">INFOUES</h2>
      ...
      <li class="breadcrumb-item">
        ...
        <li class="breadcrumb-item active">INFOUES</li>
      </ol>
      <p>Este Sitio le facilita información relevante para ayudarle en su decisión de ingreso a la educación superior estatal costarricense. Se presenta información sobre la oferta educativa a nivel de grado y posgrado, los factores que hacen posible la excelencia académica en las universidades públicas, servicios estudiantiles, dando énfasis a la temática de Orientación Vocacional, en la cual se incluye un Instrumento Vocacional.</p>
      <h3>Visite la página oficial de: <a href="http://infoues.conare.ac.cr" target="_blank">INFOUES</a></h3>
